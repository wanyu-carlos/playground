...
non_prefixed_path = f'/LYNX/HI/lynxkite_hi_data/exports/druid_13_ingre/daily_data_celcom_contract_2018-09-15'
#non_prefixed_path = f'/LYNX/HI/lynxkite_hi_data/exports/druid_13_ingre/happiness_celcom_contract_2018-09-15'

t = lk.importParquetNow(filename=f'EMPTY$/LYNX/HI/lynxkite_hi_data/exports/druid_13_ingre/daily_data_celcom_contract_2018-09-15-parquet')
...
druid.load_file(DRUID, f'daily_data_{id}', non_prefixed_path, t.columns(), datetime.strptime(date, '%Y-%m-%d'), **daily_data.druid_config(cfg))
